...
ncc_cutoff_greens = 0.15 # some cutoff parameter for non-constant coefficients on LHS of NLBVP of G
...
tolerance = 2.0*pow(10,-4)  # tolerance for outermost loop for pb_mgrf
tolerance_pb = pow(10,-9)  # tolerance for inner loop mgrf/outermost loop pb_
